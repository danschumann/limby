...
var instanceMethods = {
  ...
  layout: function(type) {
    type = type || '';
    return this.views[join('layouts', type)] ||
      // try again with extension
      this.views[join('layouts', type + '.ect.html')] ||
      this.views[join('layouts', 'default')] ||
      this.views[join('layouts', 'default.ect.html')];
  },
  ...
  viewPath: function(p) {
    ...
    console.log(this.views, this.nativeViews)
    console.log(p)
